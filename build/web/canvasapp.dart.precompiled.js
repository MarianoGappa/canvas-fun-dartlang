...
([["","file:///Users/marianol/dart/canvasapp/web/Cursor.dart",,D,{
"^":"",
W2:{
"^":"a;x>,y>"}}],["","file:///Users/marianol/dart/canvasapp/web/GradientCursor.dart",,K,{
"^":"",
SX:{
"^":"W2;yx,TQ,uN,jn,kc>,r,UI,b,ZB,Gp,Hn,Ql,zn,x,y,cN",
Kw:function(a){var z,y,x,w,v,u,t,s,r
for(z=this.kc,y=0;y<100;++y){this.ZB=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
this.Gp=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
this.Hn=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
this.Ql=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
this.zn=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
x=this.x
w=this.ZB
v=this.y
u=this.Gp
...
u=w+v
a.toString
if(x>=0&&u>=0&&x<500&&u<500){u=this.jn
u=r>u-z&&r<u+z}else u=!1
if(u){this.x=x
w+=v
this.y=w
v=this.r
...
if(s>=0&&s<=255)t=s
this.b=t
a.Tk(x,w,new E.Vb(v,u,t,255))}x=this.uN+1
this.uN=x
if(x===1000){this.jn=this.jn+1
this.uN=0}}}}}],["","file:///Users/marianol/dart/canvasapp/web/IMap.dart",,G,{
"^":"",
wZ:{
"^":"a;z1",
...
if(y>=x)return H.e(z,y)
z[y]=c.a},
rK:function(a,b){return a>=0&&b>=0&&a<500&&b<500},
VO:function(a,b){var z=[new Y.kS(-1,-1),new Y.kS(0,-1),new Y.kS(1,-1),new Y.kS(-1,0),new Y.kS(1,0),new Y.kS(-1,1),new Y.kS(0,1),new Y.kS(1,1)]
H.Ap(z,new G.Ec(this,a,b))
P.JS(z)
return z}},
Ec:{
"^":"Tp:1;a,b,c",
...
return!this.a.rK(z+x,w+y)}}}],["","file:///Users/marianol/dart/canvasapp/web/RGBA.dart",,E,{
"^":"",
Vb:{
"^":"a;r,UI,b,a"}}],["","file:///Users/marianol/dart/canvasapp/web/RandomCursor.dart",,Z,{
"^":"",
lm:{
"^":"W2;ZB,Gp,x,y,cN",
Kw:function(a){var z,y,x,w,v
for(z=0;z<100;++z){this.ZB=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
y=C.CD.yu(C.CD.UD(this.cN.w7()*2))-1
this.Gp=y
x=this.x+this.ZB
w=this.y
v=w+y
a.toString
if(x>=0&&v>=0&&x<500&&v<500){this.x=x
y=w+y
this.y=y
a.Tk(x,y,new E.Vb(this.cN.j1(255),this.cN.j1(255),this.cN.j1(255),this.cN.j1(255)))}}}}}],["","file:///Users/marianol/dart/canvasapp/web/RelativeCursor.dart",,B,{
"^":"",
P4:{
"^":"W2;uu,r,UI,b,ZB,Gp,Ql,x,y,cN",
Kw:function(a){var z
for(z=0;z<2;++z)this.G0(a)},
G0:function(a){var z,y,x,w,v,u,t
z=[]
y=this.uu
H.bQ(y,new B.wu(this,a,z))
H.bQ(z,new B.ro(this))
H.qe(y,null)
x=y.length
if(x>100){w=x-1
if(w>x)H.vh(P.TE(w,100,x))
H.Gj(y,w,y,100,x-w)
C.Nm.sB(y,x-(w-100))}this.UI=this.UI+(C.CD.yu(C.CD.UD(this.cN.w7()*2))-1)
x=this.x
w=y.length
...
z=this.b
y=J.RE(a)
x=z.VO(y.gx(a),y.gy(a))
y=this.a
H.Ap(x,new B.Xq(y,z,a))
H.bQ(x,new B.vc(y,z,a))
H.bQ(x,new B.z1(this.c,a))}},
Xq:{
"^":"Tp:1;d,e,f",
call$1:function(a){var z,y,x,w,v,u,t,s
z=this.d
if(z.uu.length>10)if(C.CD.yu(C.CD.UD(z.cN.w7()*2))===0){z=this.f
y=J.RE(z)
x=y.gx(z)
w=J.RE(a)
v=w.gx(a)
...
y=u.gRn(y)
u=y.length
if(s>>>0!==s||s>=u)return H.e(y,s)
v=y[s]
x=s+1
if(x>=u)return H.e(y,x)
x=y[x]
t=s+2
if(t>=u)return H.e(y,t)
t=y[t]
w=s+3
if(w>=u)return H.e(y,w)
w=y[w]
z=!(v===0&&x===0&&t===0||w===0)}else z=!1
else z=!1
return z}},
vc:{
"^":"Tp:1;UI,bK,Gq",
...
if(typeof w!=="number")return H.s(w)
y=this.UI
return this.bK.Tk(x+v,z+w,new E.Vb(y.r,y.UI,y.b,255))}},
z1:{
"^":"Tp:1;Rm,w3",
call$1:function(a){var z,y,x,w,v
z=this.w3
...
if(typeof z!=="number")return z.g()
if(typeof w!=="number")return H.s(w)
return this.Rm.push(new Y.kS(x+v,z+w))}},
ro:{
"^":"Tp:1;HZ",
call$1:function(a){return this.HZ.uu.push(a)}}}],["","file:///Users/marianol/dart/canvasapp/web/XY.dart",,Y,{
"^":"",
kS:{
"^":"a;x>,y>"}}],["_foreign_helper","dart:_foreign_helper",,H,{
"^":"",
FK:{
...
"%":"ArrayBuffer|Blob|DOMError|DOMImplementation|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
VX:{
"^":"Tp:10;c",
call$1:function(a){return this.c(a)}}}],["","file:///Users/marianol/dart/canvasapp/web/canvasapp.dart",,E,{
"^":"",
Iq:[function(){var z,y,x,w,v
z=document.body.querySelector("#canvas")
y=J.RE(z)
y.sR(z,500)
y.sfg(z,500)
$.eo=y.Bf(z,"2d")
...
w=y.gBb(x)
y=y.gG6(x)
v=H.VM(new W.Cq(z,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,v.uv,v.Ph,W.VF(new E.em(new Y.kS(w,y))),v.Sg),[H.Kp(v,0)]).Zz()
v=J.iH($.eo,500,500)
$.Im=v
$.Ir=new G.wZ(v)
v=$.ZS()
y=new Z.lm(0,0,250,250,null)
y.cN=C.pr
v.NZ(y)
y=$.ZS()
w=new K.SX(null,null,0,3,3,127,127,127,0,0,0,0,0,50,50,null)
w.cN=C.pr
w.yx=50
w.TQ=50
y.NZ(w)
y=$.ZS()
w=[]
v=new B.P4(w,50,127,50,0,0,0,0,0,null)
v.cN=C.pr
w.push(new Y.kS(0,0))
y.NZ(v)
P.SZ(P.k5(0,0,0,5,0,0),E.I2())
P.SZ(P.k5(0,0,0,50,0,0),E.vN())},"call$0","eE",0,0,0],
jE:[function(a){$.ZS().aN(0,new E.zu())
J.cj($.eo,$.Im,0,0)},"call$1","I2",2,0,1],
WY:[function(a){var z,y,x,w,v,u
z=J.Qd($.Im)
for(y=z.length,x=1,w=0;w<x;w+=4,x=y){v=w+3
if(v>=y)return H.e(z,v)
u=z[v]
z[v]=u>0?u-1:u}},"call$1","vN",2,0,1],
em:{
"^":"Tp:1;a",
...
if(typeof x!=="number")return H.s(x)
u=z-x
J.GD(document.body.querySelector("#xy"),"(X, Y) = ("+H.d(v)+", "+H.d(u)+")")
return new Y.kS(v,u)}},
zu:{
"^":"Tp:1;",
call$1:function(a){return a.Kw($.Ir)}}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
T9:[function(a){return J.v1(a)},"call$1","py",2,0,4],
...
I.$lazy($,"cursors","vF","ZS",function(){var z=H.VM(new P.Sw(null,0,0,0),[null])
z.Eo(null,null)
return z})
...
init.metadata=[{func:"NT"},{func:"aB",args:[null]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Vv",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"bh",args:[null,null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"YI",void:true,args:[P.a]},{func:"qu",void:true,args:[W.KV]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
V6.prototype=$desc
function W2(x,y){this.x=x
this.y=y}W2.builtin$cls="W2"
if(!"name" in W2)W2.name="W2"
$desc=$collectedClasses.W2
if($desc instanceof Array)$desc=$desc[1]
W2.prototype=$desc
W2.prototype.gx=function(receiver){return this.x}
W2.prototype.gy=function(receiver){return this.y}
function SX(yx,TQ,uN,jn,kc,r,UI,b,ZB,Gp,Hn,Ql,zn,x,y,cN){this.yx=yx
this.TQ=TQ
this.uN=uN
this.jn=jn
this.kc=kc
...
this.x=x
this.y=y
this.cN=cN}SX.builtin$cls="SX"
if(!"name" in SX)SX.name="SX"
$desc=$collectedClasses.SX
if($desc instanceof Array)$desc=$desc[1]
SX.prototype=$desc
SX.prototype.gkc=function(receiver){return this.kc}
function wZ(z1){this.z1=z1}wZ.builtin$cls="wZ"
...
this.b=b
this.c=c}Ec.builtin$cls="Ec"
if(!"name" in Ec)Ec.name="Ec"
$desc=$collectedClasses.Ec
if($desc instanceof Array)$desc=$desc[1]
Ec.prototype=$desc
function Vb(r,UI,b,a){this.r=r
this.UI=UI
this.b=b
this.a=a}Vb.builtin$cls="Vb"
if(!"name" in Vb)Vb.name="Vb"
$desc=$collectedClasses.Vb
if($desc instanceof Array)$desc=$desc[1]
Vb.prototype=$desc
function lm(ZB,Gp,x,y,cN){this.ZB=ZB
this.Gp=Gp
this.x=x
this.y=y
this.cN=cN}lm.builtin$cls="lm"
if(!"name" in lm)lm.name="lm"
$desc=$collectedClasses.lm
if($desc instanceof Array)$desc=$desc[1]
lm.prototype=$desc
function P4(uu,r,UI,b,ZB,Gp,Ql,x,y,cN){this.uu=uu
this.r=r
this.UI=UI
this.b=b
this.ZB=ZB
...
if($desc instanceof Array)$desc=$desc[1]
wu.prototype=$desc
function Xq(d,e,f){this.d=d
this.e=e
this.f=f}Xq.builtin$cls="Xq"
if(!"name" in Xq)Xq.name="Xq"
$desc=$collectedClasses.Xq
if($desc instanceof Array)$desc=$desc[1]
Xq.prototype=$desc
function vc(UI,bK,Gq){this.UI=UI
this.bK=bK
...
if($desc instanceof Array)$desc=$desc[1]
vc.prototype=$desc
function z1(Rm,w3){this.Rm=Rm
this.w3=w3}z1.builtin$cls="z1"
if(!"name" in z1)z1.name="z1"
$desc=$collectedClasses.z1
if($desc instanceof Array)$desc=$desc[1]
z1.prototype=$desc
function ro(HZ){this.HZ=HZ}ro.builtin$cls="ro"
if(!"name" in ro)ro.name="ro"
$desc=$collectedClasses.ro
if($desc instanceof Array)$desc=$desc[1]
ro.prototype=$desc
function kS(x,y){this.x=x
this.y=y}kS.builtin$cls="kS"
if(!"name" in kS)kS.name="kS"
$desc=$collectedClasses.kS
if($desc instanceof Array)$desc=$desc[1]
kS.prototype=$desc
kS.prototype.gx=function(receiver){return this.x}
kS.prototype.gy=function(receiver){return this.y}
...
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,Az,QP,IF,n6,Ny,Y5,Gc,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,ae,cv,Fs,hY,ea,D0,as,dU,Aa,u5,Yu,iG,jP,Ax,xf,ik,ST,tb,Sg,pA,Mi,HL,In,wP,eP,AL,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,xe,BV,bn,Ik,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,A6,MC,iQ,qI,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,fA,Oi,UM,o5,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,WD,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,jr,j2,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,D8,ET,df,zU,K8,xj,dE,Zc,dT,N2,LN,V6,W2,SX,wZ,Ec,Vb,lm,P4,wu,Xq,vc,z1,ro,kS,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,DH,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,em,zu,aL,a7,i1,xy,MH,A8,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,M0,Cv,e7,zL,ec,dx,kE,tJ,i7,Fk,RO,Cq,xC,JQ,Pb,vD,mD,Eg,m6,ct,tE,Ow,W9,rB,kF,mk,MM,fm,IU,mg,hL,IN,tn,b0,Dg,Ob,GV,Pg,fj,Ip,nl]}